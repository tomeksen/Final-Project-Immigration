...
const DashboardHome = () => {
  ...
  const [errorPayment, setErrorPayment] = useState<string | null>("");
  const [isLoading, setIsLoading] = useState<boolean>(false);
  const [payments, setPayments] = useState<PaymentFiltered[]>([]);

  const isAdminUser =
    user?.user?.publicMetadata.role === "admin" ? true : false;
  if (isAdminUser) {
          ...
          <div className="h-full p-6 w-full bg-gray-100">
            <div className="flex justify-between items-center mb-8">
              ...
              <Select defaultValue="Maria_CICCC_UX/UI_2">
                ...
                <SelectContent>
                  <SelectItem value="Maria_CICCC_UX/UI_2">
                    Maria_CICCC_UX/UI_2
                  </SelectItem>
                </SelectContent>
              </Select>
            ...
            <div className=" max-w-screen flex flex-col">
              ...
              <div className="flex flex-1 flex-col gap-4 p-4">
                ...
                <div className="hidden xl:grid gap-4 xl:grid-cols-3 xl:grid-rows-2 ">
                  ...
                  <div className="rounded-xl bg-muted/50 xl:col-span-1 xl:grid-rows-1 max-h-[350px]">
                    <AppPaymentSwiper swiperType="sm" payments={payments} />
                  </div>
                  {/* Row 2 */}
                      ...
                      <CardContent className="p-6">
                        ...
                        <div className="space-y-4">
                          {[
                            ...
                            {
                              title: "Review IMM and Visa documents",
                              messages: 1,
                              attachments: 2,
                              avatars: 2,
                            },
                    ...
                    <Card>
                      <CardContent className="p-6">
                        ...
                        <div className="space-y-3">
                          {[
                            {
                              text: "You've received email with instructions",
                              date: "8:13 AM",
                            },
                            {
                              text: "Your documents have been reviewed successfully",
                              date: "21/07/24",
                            },
                            {
                            ...
                            {
                              text: "Actions needed: Payment for processing fees",
                              date: "17/05/24",
                            },
                            {
                              text: "Actions needed: Biometrics Fee Payment",
                              date: "08/02/24",
                            },
                          ].map((update, index) => (
                            <div
